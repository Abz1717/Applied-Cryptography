...
CPPFLAGS=-Wall -pedantic -Wextra -std=c++11 -Wno-deprecated-declarations -DDOMAIN=\"api.authservice.co.uk\" -I/opt/homebrew/include -L/opt/homebrew/lib -I/opt/homebrew/opt/curl #-g -DDEBUG
